...
| **서버** | [multiplayer-dungeon-rpg-server](https://github.com/mint-cocoa/multiplayer-dungeon-rpg-server) on [libiouring-core](https://github.com/mint-cocoa/libiouring-core) |
...
DirectX 11 API로 제작한 멀티플레이 던전 RPG 클라이언트입니다. `libiouring-core` 기반 `multiplayer-dungeon-rpg-server`와 연동되며, 엔진 런타임에 의존하지 않고 DX11 파이프라인, 리소스 로더, 네트워크 계층을 직접 구현해 저수준 렌더링과 네트워크 동작을 다뤄보는 것이 목표였습니다.
```
isometric_client/
├── src/
...
| [multiplayer-dungeon-rpg-server](https://github.com/mint-cocoa/multiplayer-dungeon-rpg-server) | 연동 게임 서버 |
| [libiouring-core](https://github.com/mint-cocoa/libiouring-core) | 서버 런타임 |
:::
