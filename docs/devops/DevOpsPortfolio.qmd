...
```{mermaid}
flowchart LR
    Portfolio[portfolio.mintcocoa.cc<br/>mint-cocoa.github.io] --> Dashboard[OpsDashboard.html]
...
바인딩됩니다. CORS는 `https://portfolio.mintcocoa.cc`와
`https://mint-cocoa.github.io`만 허용합니다.
...
### Ingress And Live Portfolio

`portfolio.mintcocoa.cc` Ingress는 nginx class를 사용하고, MetalLB가 할당한
`172.30.1.240` LoadBalancer IP를 통해 서비스로 연결됩니다.
