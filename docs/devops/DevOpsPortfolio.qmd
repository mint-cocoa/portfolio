...
경로는 GitHub Pages이며, `portfolio.mintcocoa.cc`는 같은 `docs/` 산출물을 서빙하는
홈랩 미러 경로로 운영합니다.
...
- `portfolio`: GitHub Pages와 같은 `docs/` 산출물을 C++ RuntimeWeb 컨테이너로 서빙하는 홈랩 미러
...
|---|---|
| `portfolio.mintcocoa.cc` | `200 OK` 문서 미러 |
...
같은 정적 문서 산출물을 C++ `RuntimeWeb` 컨테이너가 서빙하는 미러 경로입니다.
    ...
    <section class="route-destination route-kubernetes">
      ...
      <div class="route-leaf-list">
        <div class="route-leaf live">
          ...
          <span>portfolio service -&gt; docs mirror</span>
        </div>
        <div class="route-leaf live">
...
proxy와 C++ RuntimeWeb 컨테이너를 통과하는 미러로 운영할 수 있습니다. 남은 문제는
...
현재 이 호스트는 GitHub Pages와 같은 정적 문서 산출물을 홈랩에서 미러링하는 경로입니다.
